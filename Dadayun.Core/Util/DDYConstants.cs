...
{
    internal static class DDYConstants
    {
        public const string MNS_SERVICE_NAME = "Aliyun.MNS";
        ...
        public const string DDY_XML_NAMESPACE = "http://www.dadayun.cn/doc/v1";
        public const string DDY_AUTHORIZATION_HEADER_PREFIX = "DDY";
        public const string X_DDY_HEADER_PREFIX = "x-ddy-";
        ...
        public const string ContentTypeTextJson = "application/x-www-form-urlencoded; charset=UTF-8";
    }
}
