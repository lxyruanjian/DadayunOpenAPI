...
{
    /// <summary>
    /// This class defines utilities and constants that can be used by DDY clients.
    /// </summary>
    public static partial class DadayunSDKUtils
    {
        #region Internal Constants

        internal const string SDKVersionNumber = "1.0.0.0";
        internal static string _userAgentBaseName = "dadayun-sdk-dotnet";
